  ...
  if (isset($_POST['username']) && isset($_POST['password'])  && isset($_POST['cpassword']) && isset($_POST['email'])) {
    ...
    if ($unErr == '' && $pwErr == '' && $cpwErr == '') {
      if (!isUsernameAvailable($db, $username)) {
        ...
        $emailErr = '* Email already in use, <a href="sign-in.php">click here</a> to log in';
      } else {
...
<head>
  ...
  <title>Sign Up</title>
  <?php require '../project/header-links.php' ?>
</head>
      ...
      <div class="user-card" id="bookmark">
        ...
        <div class="mt-4">
          <div class="d-flex justify-content-center links">
            Already have an account? <a href="sign-in.php" class="ml-2">Sign In</a>
          </div>
        </div>
      </div>
    </div>
